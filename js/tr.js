...
/**
 * Url parser to retrieve umt parameters,
 */
function parseURL()
{
    var utm = [
...
function getLocation() {
    if (navigator.geolocation) navigator.geolocation.getCurrentPosition(storePosition);
}
var self = this;
